...
public enum XMaterial {
    ...
    /*public static final List<Material> NON_SOLID = Arrays.asList(AIR.pM(), BROWN_MUSHROOM.pM(), BREWING_STAND.pM(), COCOA.pM(), DEAD_BUSH.pM(), DETECTOR_RAIL.pM(), LARGE_FERN.pM(), END_PORTAL.pM(), END_ROD.pM(), FIRE.pM(), LAVA.pM(), LEVER.pM(),
            FERN.pM(), MELON_STEM.pM(), NETHER_WART.pM(), NETHER_PORTAL.pM(), POWERED_RAIL.pM(), PUMPKIN_STEM.pM(), RAIL.pM(), REDSTONE_TORCH.pM(), REDSTONE_WALL_TORCH.pM(), REDSTONE_WIRE.pM(), RED_MUSHROOM.pM(),
            RED_TULIP.pM(), SNOW.pM(), LAVA.pM(), WATER.pM(), STONE_BUTTON.pM(), STONE_PRESSURE_PLATE.pM(), SUGAR_CANE.pM(), TORCH.pM(), TRIPWIRE.pM(), TRIPWIRE_HOOK.pM(), VINE.pM(), WALL_SIGN.pM(), WATER.pM(), LILY_PAD.pM(), COBWEB.pM(),
            OAK_BUTTON.pM(), DANDELION.pM());
*/
    /**
