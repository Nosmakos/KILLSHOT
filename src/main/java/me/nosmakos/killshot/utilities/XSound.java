...
public enum XSound {
    ...
    public void playSound(Player player) {
        parsePlayedSound(player.getLocation(), 0.25F, 1.0F);
    }

    public void parsePlayedSound(Location location, float f1, float f2) {
        location.getWorld().playSound(location, parseSound(), f1, f2);
    }
}